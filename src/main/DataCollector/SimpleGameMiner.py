...
if __name__ == '__main__':
    for tourny in tourny_list:
        ...
        for tournament in list(tournament_names['hash']):
            match_ids = PastCollector.get_hashes_in_tournament(tourny, tournament)
        ...
        df_to_write.to_csv(_constants.data_location + 'simple_game_data_leagueId={}.csv'.format(tourny))
